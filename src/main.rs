...
mod message;
use message::{GreetRequest, GreetResponse};
            ...
            SwarmEvent::Behaviour(AgentEvent::Identify(event)) => match event {
                ...
                IdentifyEvent::Received { peer_id, info } => {
                    ...
                    for addr in info.clone().listen_addrs {
                        ...
                        let message = GreetRequest {
                            message: format!("Send message from: {local_peer_id}: Hello there"),
                        };
                    ...
                    match message {
                        RequestResponseMessage::Request {
                            ...
                            let response = GreetResponse {
                                message: format!("Response from: {local_peer_id}: hello too"),
                            };
